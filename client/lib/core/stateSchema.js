...
const stateSchema = avro.Type.forSchema({
  ...
  fields: [
    ...
    { name: 'velocityX', type: ["null", "int"], default: null }, // legacy, removed soon
    { name: 'velocityY', type: ["null", "int"], default: null }, // legacy, removed soon
    ...
    {
      name: 'states',
      type: ['null', { type: 'array', items: 'State' }],
      default: null
    },
    {
